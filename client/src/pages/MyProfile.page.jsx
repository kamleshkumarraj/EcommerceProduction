...
function MyProfile() {
  ...
  const question = [
    {
      ques: "What happens when I update my email address (or mobile number)?",
    ...
    {
      ques: "When will my Shopify account be updated with the new email address (or mobile number)?",
      ans: "It happens as soon as you confirm the verification code sent to your email (or mobile) and save the changes.",
    },
    {
      ques: "What happens to my existing Shopify account when I update my email address (or mobile number)?",
    ...
    {
      ques: "Does my Seller account get affected when I update my email address?",
    ...
    <div className="flex items-center justify-center  mx-[20px] white">
      <div className="w-full p-6 bg-white rounded-lg shadow-lg">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center text-[2rem] font-bold text-gray-800">
        ...
        <div className="flex gap-6">
          ...
          />
          <div>
            <h1 className="text-[2.4rem] font-semibold text-gray-800">
              {user?.firstname + " " + user?.lastname}
            </h1>
            <p className="text-blue-500">Product Designer</p>
            <div className="flex items-center mt-2 text-gray-700">
              <span className="text-[1.8rem] font-semibold">5.6</span>
        ...
        <div id="faq" className="pt-6 mt-6 border-t">
          <h1 className="text-[24px] font-[600] relative">
            FAQ{" "}
            <span className="absolute top-[5%]  text-[24px] font-[600] text-blue-500">
              s
            </span>
          </h1>
          <div id="details">
            {question.map(({ ques, ans }) => {
              return (
                <div key={ques} className="mt-4">
                  <h1 className="text-[16px] text-[#000000b7] font-[600]">
                    What happens when I update my email address (or mobile
                    number)?
                  </h1>
                  <p className="text-[15px] font-[500] text-[#00000084] my-[15px]">
                    {ans}
                  </p>
                </div>
              );
          ...
          <h1 className="text-[16px] font-[500] text-[red] relative mt-[20px] hover:cursor-pointer">
            Delete Account{" "}
          </h1>
        </div>
      </div>
