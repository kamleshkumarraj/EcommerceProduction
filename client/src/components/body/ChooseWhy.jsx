...
const WhyChooseUs = () => {
  return (
    <div className="bg-green-100 py-[80px]">
      <h2 className="mb-8 text-black text-[2.4rem] font-bold text-center">
        Why choose us?
      </h2>
      <div className="grid max-w-[1300px] grid-cols-1 gap-[20px] lg:gap-[50px] mx-auto md:grid-cols-3">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 bg-white rounded-full">
            <FaGift className="text-[3rem] text-black" />
          </div>
          <h3 className="mb-2 text-[1.8rem] text-black font-bold">
        ...
        {/* Card 2 */}
        <div className="text-center">
          <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-black bg-white rounded-full">
            <FaShippingFast className="text-[3rem] text-black" />
          </div>
          <h3 className="mb-2 text-black text-[1.8rem] font-bold">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 text-black bg-white rounded-full">
            <FaUsers className="text-[3rem] text-black" />
          </div>
          <h3 className="mb-2 text-black text-[1.8rem] font-bold">
