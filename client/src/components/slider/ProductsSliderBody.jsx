...
export default function ProductsSliderBody({ productsList, title }) {
  return (
    <div className="px-[40px]">
      <div className="flex mx-[40px] flex-col text-[3.6rem] mt-[20px] text-slate-600 font-bold relative pb-[45px]">
        <h2>{title}</h2>
      ...
      <div className="" id="products-slider">
        <Swiper
          ...
          modules={[Navigation]}
          className={`${
            title == "Top Rated Products" ? "pb-[160px]" : "pb-[20px] "
          } bg-gray-200`}
          style={
            ...
            productsList.map((item) => (
              ...
              >
                {title == "Latest Products" ? (
                  ...
                  <TwoLayerCard item={item} />
                ) : (
                  <OfferedProductCard item={item} />
                )}
              </SwiperSlide>
            ))}
        </Swiper>
