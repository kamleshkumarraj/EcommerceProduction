      ...
      >
        ...
        >
          <div id="left" className="flex flex-col gap-1">
            <h1 className="text-[1.8rem] font-bold text-purple-700 font-poppins">
              Order no: {order?._id || order?.productId}
            </h1>
            <p className="text-[1.4rem] font-medium text-gray-500 font-roboto">
              Order Date: <span className="text-gray-400">{createdAt}</span>
            </p>
            <p className="text-[1.4rem] font-medium text-gray-500 font-roboto">
              Estimated Delivery:{" "}
              <span className="text-gray-400">22/03/2024</span>
            </p>
          </div>
        ...
        >
          ...
          >
            <div
              id="img"
              className={`max-w-[120px] gap-[10px] ${
                itemLength == 1
                  ? "w-full"
                  : itemLength == 2
                  ? "w-full grid grid-cols-2"
                  : "grid w-full grid-cols-2 grid-rows-2 justify-items-center"
              } `}
            >
              {order?.orderItems
                .slice(0, itemLength > 4 ? 3 : itemLength)
                .map((item) => (
                  <img
                    src={item.image}
                    alt={item.name}
              ...
              {itemLength > 4 && (
                <p className="self-center w-full mx-auto text-[1.4rem] font-medium text-center text-gray-500 font-roboto">
                  +{itemLength - 3} more
                </p>
              )}
            </div>
            <div id="img-detail" className="flex flex-col gap-1">
              <p className="text-[1.4rem] font-semibold text-gray-800 font-poppins">
              ...
              <p className="text-[1.4rem] font-bold text-gray-700 font-roboto">
                Total:{" "}
                <span className="text-purple-600">${priceQty.price}</span>
              </p>
            </div>
          </div>
          <Link
          ...
          >
            <p className="text-[1.4rem] font-bold text-white font-poppins">
              View Details
            </p>
          </Link>
        </div>
