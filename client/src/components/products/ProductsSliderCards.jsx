  ...
  return (
    <div  className="w-[35rem] rounded-[10px] overflow-hidden bg-[#ffffff] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.25)]" >
      <div id="img-section" className='h-[300px] rounded-[20px] w-full relative'>
        ...
        <div onClick={() => addWishlistItem(dispatch , product)} id="icon-wishlist" className='absolute top-[10%] right-[1%] transform z-[999] -translate-x-1/2 -translate-y-1/2 hover:cursor-pointer'>
            <FaHeart className='hover:cursor-pointer'  size={'25px'} color='#ff5a5f' />
        </div>
      ...
      <div id="text-section" className='py-[15px]' >
        ...
        <div id="btn-section" className='flex justify-between px-[10px] pt-[10px]'>
            <button onClick={() => addToCart(product._id , dispatch , user)}  className='bg-[#0000002f] text-[16px] font-[500] text-white py-[5px] px-[10px] rounded-[5px] hover:bg-[#00000040]'>Add to Cart</button>
