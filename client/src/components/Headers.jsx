                    ...
                    <div className='flex w-full justify-between items-center h-[50px] text-slate-500'>
                        ...
                        <div>
                            <div className='flex items-center justify-center gap-10'>
                                ...
                                {
                                    userInfo ? <Link className='flex items-center justify-center gap-2 text-sm cursor-pointer' to='/dashboard'>
                                        <span><FaUser /></span>
                                        <span>{userInfo.name}</span>
                                    </Link> : <Link to='/login' className='flex items-center justify-center gap-2 text-sm cursor-pointer'>
                                        <span><FaLock /></span>
                                        <span>Login</span>
                                    </Link>
                                }
                        ...
                        <div className='flex items-center gap-10 justify-star'>
                            ...
                            </div>
                            {
                                userInfo ? <Link className='flex items-center justify-center gap-2 text-sm cursor-pointer' to='/dashboard'>
                                    <span><FaUser /></span>
                                    <span>{userInfo.name}</span>
                                </Link> : <div className='flex items-center justify-center gap-2 text-sm cursor-pointer'>
                                    <span><FaLock /></span>
                                    <span>Login</span>
                                </div>
                            }
                        ...
                        <div className='flex flex-wrap items-center justify-between w-full md-lg:gap-6'>
                            <div className='w-8/12 md-lg:w-full'>
                                <div className='flex border h-[50px] items-center relative gap-5'>
                                    ...
                                    <input className='relative w-full h-full px-3 bg-transparent text-slate-500 outline-0' onChange={(e) => setSearchValue(e.target.value)} type="text" name="" id="" placeholder='what do you need' />
                                    <button onClick={search} className='absolute right-0 h-full px-8 font-semibold text-white uppercase bg-violet-400'>Search</button>
                                </div>
                            </div>
                            <div className='block w-4/12 pl-2 md-lg:hidden md-lg:w-full md-lg:pl-0'>
                                <div className='flex items-center justify-end w-full gap-3 md-lg:justify-start'>
                                    ...
                                    <div className='flex flex-col justify-end gap-1'>
                                        <h2 className='font-medium text-md text-slate-700'>+8803242343243</h2>
