...
const ReviewSection = () => {
  const reviews = [
    {
      ...
      stars: 5,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSU_TIpEbGConvxJa-0ov5dHJtths65_bsRzQ&s", // Replace with actual image link
    },
    {
      name: "Daniel Adam",
      ...
      stars: 5,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYiQVI64BOhcmcvgwR3TrgsgxkEyWmQCdz9g&s", // Replace with actual image link
    },
    {
      name: "Masirul Islam",
      date: "March 20, 2024 at 2:37 pm",
  ...
  return (
    <div className="p-[3.2rem] px-[80px]">
      <h2 className="mb-4 text-[2.4rem] font-bold">02 Reviews</h2>
