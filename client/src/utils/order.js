...
export const fetchOrder = async ({ dispatch }) => {
  const options = {
    url: "http://internal-backend-internal-alb-1173943540.ap-south-1.elb.amazonaws.com/api/v2/user/order/all-orders",
    method: "GET",
  };
...
export const fetchCreateOrder = async ({ dispatch, payload }) => {
  const options = {
    method: "POST",
    url: "http://internal-backend-internal-alb-1173943540.ap-south-1.elb.amazonaws.com/api/v2/user/order/create-order",
    formData: payload,
  };
...
export const fetchSingleOrder = async ({ dispatch, payload }) => {
  try {
    const options = {
      method: "GET",
      url: `http://internal-backend-internal-alb-1173943540.ap-south-1.elb.amazonaws.com/api/v2/user/order/single-order/${payload}`,
    };
