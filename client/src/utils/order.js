...
export const fetchOrder = async ({ dispatch }) => {
  const options = {
    url: "https://ecommerceproduction.onrender.com/api/v2/user/order/all-orders",
    method: "GET",
  };
...
export const fetchCreateOrder = async ({ dispatch, payload }) => {
  const options = {
    method: "POST",
    url: "https://ecommerceproduction.onrender.com/api/v2/user/order/create-order",
    formData: payload,
  };
...
export const fetchSingleOrder = async ({ dispatch, payload }) => {
  try {
    const options = {
      method: "GET",
      url: `https://ecommerceproduction.onrender.com/api/v2/user/order/single-order/${payload}`,
    };
